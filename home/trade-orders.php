...
<body>
	...
	<div id="fh5co-hero-wrapper">
		...
		<div class="container fh5co-hero-inner">
			...
			<br><br>
			<h3 class="tags"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;<b><i>Orders section</i></b></h3> <br><br>
			<div class="container">
				<div class="row">
					<div class="col-md-3">
		...
		<div class="row">
			...
			<div class="col-md-12">
				<?php
					...
					$sql2 = mysqli_query($con,"SELECT * FROM `request` WHERE `purchase_rollno`='$roll'");
						while($row2=mysqli_fetch_array($sql2))
						{

				?>
				<br>
				<img style="float: right; height: 20px; width: 20px; padding-left: 50px;" src="images/product-img/<?php echo $row2['item_image'] ?>">
				<br>
				<form method="POST">
					<h5><i class="fa fa-text-width" aria-hidden="true"></i>&nbsp;Title : <?php echo $row2['title']; ?></h5>
					<h5><i class="fa fa-cart-plus" aria-hidden="true"></i>&nbsp;Category : <?php echo $row2['category']; ?></h5>
					<h5><i class="fa fa-inr" aria-hidden="true"></i>&nbsp;Price : <?php echo $row2['sell_price']; ?></h5>
					<h5><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Purchasing from : <?php echo $row2['owner_name']; ?></h5>
					<h5><i class="fa fa-phone-square" aria-hidden="true"></i>&nbsp;Contact : <?php echo $row2['owner_contact']; ?></h5>
					<h5><i class="fa fa-question-circle-o" aria-hidden="true"></i>&nbsp;Status : Pending for approval</h5>
					<br>
		...
		<div class="row">
			...
			<div class="col-md-12">
				<?php
					...
					$sql = mysqli_query($con,"SELECT * FROM `orders` WHERE `pur_rollno`='$roll'");
						while($row=mysqli_fetch_array($sql))
						{

				?>
				<br>
				<img style="float: right; height: 180px; width: 280px; margin-left: 35px; border: 1px solid black;" src="images/product-img/<?php echo $row['item-img'] ?>">
				<br>
				<form method="POST">
					...
					<h5><i class="fa fa-inr" aria-hidden="true"></i>&nbsp;Price : <?php echo $row['price']; ?></h5>
					<h5><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Purchased from : <?php echo $row['own_name']; ?></h5>
					<br>
